...
class ZaiLlmService {
    ...
    async streamCompletion(systemPrompt, content) {
        ...
        if (!response.ok) {
            ...
            throw new functions.https.HttpsError("internal", `ZAI API error: ${response.status} ${response.statusText}`);
        }
        return response;
    }
...
exports.ZaiLlmService = ZaiLlmService;
//# sourceMappingURL=zaiLlmService.js.map